...
namespace scp
{
	...
	class Quat
	{
		public:
			...
			constexpr void setFromUnitVectorRotation(const TValue& xFrom, const TValue& yFrom, const TValue& zFrom, const TValue& xTo, const TValue& yTo, const TValue& zTo, float dutchAngle);
